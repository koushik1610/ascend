...
if __name__ == "__main__":
    for t in (test_server, test_html_json, test_gitignore, test_crossrefs, test_phase_order, test_op_parity, test_resume_builder, test_latex_render, test_bash_allowlist, test_honesty, test_linter, test_pipeline, test_registry, test_scripts):
        try: t()
        except Exception as e:
